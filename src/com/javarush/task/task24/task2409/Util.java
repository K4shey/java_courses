...
//                final StringBuilder sb = new StringBuilder("AbstractJeans{");
                String tm = "AbstractJeans";
                if (!this.getClass().getSimpleName().equals("")) {
                    tm = this.getClass().getSimpleName();
                }
                final StringBuilder sb = new StringBuilder(tm + "{");
