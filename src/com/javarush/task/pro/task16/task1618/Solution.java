...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ZonedDateTime zonedDateTime1 = ZonedDateTime.of(fromDateTime, fromZone);
        ZonedDateTime zonedDateTime2 = zonedDateTime1.withZoneSameInstant(toZone);
        return LocalDateTime.of(zonedDateTime2.getYear(), zonedDateTime2.getMonth(), zonedDateTime2.getDayOfMonth(),
                zonedDateTime2.getHour(), zonedDateTime2.getMinute(), zonedDateTime2.getSecond(), zonedDateTime2.getNano());
    }
}
