...
//    }
    ...
    public  void revalidate() {
        boolean randomValue;
        activeApartments.clear();
        HashSet<Apartment> apartmentsForLoop = new HashSet(getAllApartments());
        for (Apartment apartment : apartmentsForLoop) {
            randomValue = Math.random() * 2 % 2 == 0;
            if (randomValue) synchronized (this){
                apartment.revalidate(randomValue);
            }
        }
    }
